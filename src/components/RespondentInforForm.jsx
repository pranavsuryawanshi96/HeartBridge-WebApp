      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
        ...
        <div>
          ...
          >
            ...
            <option value="Male" style={{ background: "#1a1a2e" }}>
              Male
            </option>
            <option value="Female" style={{ background: "#1a1a2e" }}>
              Female
            </option>
            <option value="Other" style={{ background: "#1a1a2e" }}>
              Other
            </option>
            <option value="Prefer not to say" style={{ background: "#1a1a2e" }}>
              Prefer not to say
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          >
            ...
            <option value="Partner" style={{ background: "#1a1a2e" }}>
              💑 Partner / Spouse
            </option>
            <option value="Friend" style={{ background: "#1a1a2e" }}>
              👫 Friend
            </option>
            <option value="Best Friend" style={{ background: "#1a1a2e" }}>
              🤝 Best Friend
            </option>
            <option value="Family" style={{ background: "#1a1a2e" }}>
              👨‍👩‍👧‍👦 Family Member
            </option>
            <option value="Parent" style={{ background: "#1a1a2e" }}>
              👨‍👩 Parent
            </option>
            <option value="Sibling" style={{ background: "#1a1a2e" }}>
              👫 Sibling
            </option>
            <option value="Colleague" style={{ background: "#1a1a2e" }}>
              💼 Colleague
            </option>
            <option value="Other" style={{ background: "#1a1a2e" }}>
              🌟 Other
