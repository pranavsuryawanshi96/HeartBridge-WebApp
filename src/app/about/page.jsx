      ...
      <div style={{ position: "relative", zIndex: 1, padding: "2rem" }}>
        ...
        >
          ...
          <motion.h1
            ...
            style={{
              ...
              marginBottom: "2rem",
              background:
                "linear-gradient(135deg, #fff 0%, #ff9800 40%, #03a9f4 80%, #e91e63 100%)",
          ...
          >
            ...
            — to your partner, best friend, or family member. They answer
            honestly, and you discover new dimensions of your relationship.
          </motion.p>
        ...
        >
          ...
          >
            ...
            <TiltCard
              style={{
                background:
                  "linear-gradient(135deg, rgba(233,30,99,0.2), rgba(255,152,0,0.1))",
            ...
            >
              ...
              >
                "What's your favorite memory of us?" "What makes you feel most
                loved?" Deepen intimacy and understanding with meaningful
                conversations.
              </p>
            </TiltCard>
            ...
            <TiltCard
              style={{
                background:
                  "linear-gradient(135deg, rgba(3,169,244,0.2), rgba(76,175,80,0.1))",
                backdropFilter: "blur(15px)",
                padding: "3rem 2rem",
                borderRadius: "30px",
            ...
            >
              ...
              >
                "What's something you've never told me?" "When did you know we'd
                be best friends?" Strengthen your friendship through genuine
                curiosity.
              </p>
            </TiltCard>
            ...
            >
              ...
              >
                "What values are most important to you?" "What's your proudest
                moment?" Preserve family stories and create lasting memories
                together.
              </p>
            </TiltCard>
          </div>
        ...
        >
          ...
          >
            ...
            >
              In our busy lives, we often forget to ask the questions that truly
              matter. We assume we know our loved ones, but there's always more
              to discover. This platform creates space for curiosity,
              vulnerability, and genuine connection — the foundation of every
        ...
        >
          ...
          >
            <div style={{ flex: 1, minWidth: "280px" }}>
              ...
              >
                Start creating meaningful polls and questions. Connect with
                loved ones through heartfelt answers! 💝
              </p>
            </div>
